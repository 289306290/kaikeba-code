...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "." + {"1":"e61e0a42b16db389dcfa","2":"389d9546eab2f92ce2e2"}[chunkId] + ".js"
/******/ 	}
/******/
...
function createRouter() {
  return new vue_router_esm({
    ...
    routes: [{
      path: '/',
      component: () => __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 11))
    }, {
      path: '/item/:id',
      component: () => __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 10))
    }]
  });
}
...
function createStore() {
  return vuex_esm["a" /* default */].Store({
    state: {
      items: {}
    },
    actions: {
    ...
    mutations: {
      setItem(state, {
        ...
        vue_runtime_esm["default"].set(state.items, id, item);
      }
...
var vuex_router_sync = __webpack_require__(4);
...
function createApp(context) {
  ...
  const store = createStore(); // 同步路由状态(route state)和store注入

  Object(vuex_router_sync["sync"])(store, router); // 创建应用程序实例, 将router和store注入
...
entry_client_router.onReady(() => {
  ...
  entry_client_router.beforeResolve((to, from, next) => {
    ...
    const prevMatched = entry_client_router.getMatchedComponents(from); // 只关心非预渲染的组件
  ...
  entry_client_app.$mount('#app', true);
});
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=16d41905&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('router-link',{attrs:{"to":"/"}},[_vm._v("Home")]),_vm._v("  \n  "),_c('router-link',{attrs:{"to":"/item/1"}},[_vm._v("Item 1")]),_vm._v(" "),_c('router-view')],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=16d41905&scoped=true&
